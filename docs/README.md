...
2. [**Core Capabilities & Workflows** (`CAPABILITIES.md`)](./CAPABILITIES.md)
   ...
   - Issue tracker abstraction (GitHub Issues, Jira Cloud, Local SQLite).
   - Autonomous AI Skill pipeline (round-based `clarify-issue` until owner confirmation, `specify-issue`, `code-issue`, `adjust-issue`, `pick-issue`).
