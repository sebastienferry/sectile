...
window.ctx={projects:[window.project],selectedProjectId:'p1',get currentProject(){return window.project},activities:[],activeJobCount:0,activeView:'board',setActiveView:v=>{window.lastView=v},statusFilter:null,priorityFilter:null,labelFilter:null,assigneeFilter:null,sourceFilter:'all',sidebarCollapsed:false,isSyncing:false,settings:{userName:'Alice',density:'standard',theme:'dark'},teams:[],tasks:[],taskFacets:{statuses:[],sources:[],trackerStatuses:[],total:0},boardGrouping:'status',trackerStatusFilters:[],boardViews:[],selectedViewId:null,t:translations.fr,...Object.fromEntries(['setSelectedProjectId','setIsProjectModalOpen','setEditingProject','toggleProjectBookmark','setStatusFilter','setPriorityFilter','setLabelFilter','setAssigneeFilter','setSourceFilter','setSidebarCollapsed','setIsProfileOpen','setIsAdminOpen','setTrackerStatusFilters','openBoardView','openBoardViewModal'].map(n=>[n,noop]))};
