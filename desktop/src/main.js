...
function renderNextStep(){
 const run=currentTaskRun(),status=document.querySelector('#next-step-status'),button=document.querySelector('#next-step'),label=document.querySelector('#next-step-label'),markReviewed=document.querySelector('#mark-reviewed'),retry=document.querySelector('#retry-next-step'),force=document.querySelector('#force-next-step')
 button.hidden=true;button.disabled=true;label.hidden=true;retry.hidden=true
