...
function openWindow(){
 ...
 window=new BrowserWindow({show:process.env.TASKFLOW_DESKTOP_TEST!=='1',width:1240,height:820,minWidth:800,minHeight:500,backgroundColor:'#11151c',title:'TaskFlow Local',webPreferences:{preload:path.join(__dirname,'preload.cjs'),nodeIntegration:false,contextIsolation:true,sandbox:true}})
