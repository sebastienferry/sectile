...
contextBridge.exposeInMainWorld('localAgent',{
 ...
 engines:()=>ipcRenderer.invoke('engines'),
 saveEngines:input=>ipcRenderer.invoke('save-engines',input),
 taskEngines:projectId=>ipcRenderer.invoke('task-engines',projectId),
