...
- [x] Validate the OpenSpec change and preserve clarification.
- [x] Add the accessible project-row open-task action.
- [x] Load and search open tasks with stale-response, empty and error handling.
