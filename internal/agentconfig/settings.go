...
func WriteSettings(settings Overrides) error {
	...
	for _, key := range []string{"projects", "worktrees", "parallelism", "commands", "commandsAutonomous", "aiProviders", "aiModels", "terminals", "specRepos", "repositories", "viewDirectories"} {
