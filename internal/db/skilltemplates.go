...
type StageSkill struct {
	...
	// Mode pins how the skill runs: models.SkillModeInteractive,
	// models.SkillModeNonInteractive, or empty when the skill has no opinion and
	// the project default decides.
	Mode string
