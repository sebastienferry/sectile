...
- **The desktop skill badge shows a skill waiting for your answer.** While a skill run is marked as waiting, the skill badge in the run header and beside the task reads *? Waiting for your answer* in amber, next to the process state, instead of staying blank until the skill ends.
