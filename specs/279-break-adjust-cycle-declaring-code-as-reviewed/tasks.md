...
- [x] **T1** In `internal/agent/agent_desktop.go`:
...
- [x] **T2** In `internal/agent/agent_desktop_test.go`:
...
- [x] **T3** In `desktop/electron/preload.cjs`:
...
- [x] **T4** In `desktop/electron/main.cjs`:
...
- [x] **T5** In `desktop/src/workflow.mjs`:
...
- [x] **T6** In `desktop/tests/workflow.ui.cjs`:
...
- [x] **T7** In `desktop/src/index.html`:
...
- [x] **T9** In `desktop/src/main.js` (`ticketRow`):
...
- [x] **T10** In `desktop/src/main.js` (`renderNextStep` & execution toolbar):
  - In `renderNextStep()`:
...
- [x] **T12** Run full Go test suite:
  ```bash
  go test -v -race ./internal/agent/...
  ```
- [x] **T13** Run full desktop test suite:
  ```bash
  cd desktop && npm test
  ```
- [x] **T14** Verify all acceptance criteria in `spec.md` (US1 through US5).
